...
/// long enough to be worth telling the user about. The suppressor suspends a
/// failing domain silently and self-heals on a probe; only a domain that stays
/// unrecoverable with its channel present escalates to here (docs/DECISIONS.md:
/// per-domain-suspension). AppCore
